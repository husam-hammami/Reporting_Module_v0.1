export default function YieldTab() {
  return (
    <section className="tab-pane" id="tab-yield">
        ...
        <article className="card mill-card">
          <div className="mill-header">
            ...
            <p className="mill-sub">
              A real-time cross-section of the milling line. Atlas has identified a sub-optimal bran split at the{' '}
              <b>C2 plansifter</b> — the point where flour and bran separate after the second break. A{' '}
              <b className="hl-cyan">0.15mm screen tightening</b> closes a <b className="hl-amber">+1.1pp</b> extraction gap worth{' '}
              <b className="hl-cyan">~12 OMR/h</b>.
            </p>
          </div>

          <div className="mill-stage">
            <div className="mill-stage-ph">
              <svg viewBox="0 0 800 320" fill="none">
                <defs>
                  <linearGradient id="aaiMillBody" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#1a2540" />
                    <stop offset="100%" stopColor="#0a1426" />
                  </linearGradient>
                  <linearGradient id="aaiFlourBeam" x1="0" y1="0" x2="1" y2="0">
                    <stop offset="0%" stopColor="rgba(125,249,255,0)" />
                    <stop offset="50%" stopColor="rgba(125,249,255,0.65)" />
                    <stop offset="100%" stopColor="rgba(125,249,255,0)" />
                  </linearGradient>
                  <linearGradient id="aaiBranBeam" x1="0" y1="0" x2="1" y2="0">
                ...
                {/* Intake hopper */}
                <path d="M 60 60 L 160 60 L 130 120 L 90 120 Z" fill="url(#aaiMillBody)" stroke="rgba(125,249,255,0.5)" strokeWidth="1" />
                <text x="110" y="45" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="9" fill="rgba(125,249,255,0.6)" letterSpacing="0.1em">INTAKE</text>

                {/* Break rollers */}
                <rect x="220" y="100" width="140" height="80" rx="6" fill="url(#aaiMillBody)" stroke="rgba(125,249,255,0.5)" strokeWidth="1" />
                <circle cx="260" cy="140" r="18" fill="#0a1426" stroke="rgba(125,249,255,0.6)" strokeWidth="1" />
                <circle cx="320" cy="140" r="18" fill="#0a1426" stroke="rgba(125,249,255,0.6)" strokeWidth="1" />
                <circle cx="260" cy="140" r="6" fill="#7df9ff" opacity="0.7" />
                <circle cx="320" cy="140" r="6" fill="#7df9ff" opacity="0.7" />
                <text x="290" y="195" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="9" fill="rgba(125,249,255,0.6)" letterSpacing="0.1em">BREAK ROLLERS</text>

                {/* C2 plansifter (highlighted) */}
                <rect x="430" y="80" width="160" height="120" rx="8" fill="url(#aaiMillBody)" stroke="rgba(245,158,11,0.7)" strokeWidth="1.5" />
                {[100, 120, 140, 160, 180].map((y) => (
                  <line key={y} x1="445" y1={y} x2="575" y2={y} stroke="rgba(245,158,11,0.3)" strokeWidth="0.7" />
                ))}
                <rect x="430" y="80" width="160" height="120" rx="8" fill="rgba(245,158,11,0.05)" />
                <text x="510" y="65" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="9" fill="#f59e0b" letterSpacing="0.1em">C2 PLANSIFTER</text>

                {/* Output silos */}
                <rect x="650" y="60" width="60" height="60" rx="4" fill="url(#aaiMillBody)" stroke="rgba(125,249,255,0.5)" strokeWidth="1" />
                <text x="680" y="50" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="8" fill="#7df9ff" letterSpacing="0.1em">FLOUR</text>
                <rect x="650" y="160" width="60" height="60" rx="4" fill="url(#aaiMillBody)" stroke="rgba(245,158,11,0.5)" strokeWidth="1" />
                <text x="680" y="240" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="8" fill="#f59e0b" letterSpacing="0.1em">BRAN</text>

                {/* Connecting beams */}
                <line x1="160" y1="90" x2="220" y2="140" stroke="url(#aaiFlourBeam)" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="360" y1="140" x2="430" y2="140" stroke="url(#aaiFlourBeam)" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="590" y1="100" x2="650" y2="90" stroke="url(#aaiFlourBeam)" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="590" y1="180" x2="650" y2="190" stroke="url(#aaiBranBeam)" strokeWidth="2.5" strokeLinecap="round" />

                {/* Floor base */}
                <line x1="40" y1="280" x2="760" y2="280" stroke="rgba(125,249,255,0.2)" strokeWidth="0.8" strokeDasharray="4 4" />
              </svg>
            </div>
            ...
            <div className="mill-tick tl" />
            <div className="mill-tick tr" />
            <div className="mill-tick bl" />
            <div className="mill-tick br" />
          </div>
        </article>

        <aside className="yield-rail">
          <article className="card rail-card now">
            <div className="rc-eyebrow mono"><span className="rc-dot" />NOW</div>
            ...
            <div className="rc-bar"><div className="rc-fill amber" style={{ '--w': '79.1%' }} /></div>
          </article>

          <article className="card rail-card target">
            <div className="rc-eyebrow mono"><span className="rc-dot ok" />AI · TARGET</div>
            ...
            <div className="rc-bar"><div className="rc-fill green" style={{ '--w': '80.2%' }} /></div>
          </article>

          <article className="card rail-card opp">
            <div className="rc-eyebrow mono"><span className="rc-dot warn" />OPPORTUNITY</div>
      ...
      <div className="yield-diag">
        <article className="card diag-card finding">
          <div className="diag-head">
            ...
            <div>
              <div className="card-eyebrow amber"><span className="ce-dot warn" />FINDING</div>
              <h3 className="diag-title">Bran split is running 0.7pp above normal.</h3>
            </div>
          </div>
          <p className="diag-body">
            C2 plansifter bran-stream output is at <b className="amber mono">18.7%</b> versus its 5-day rolling normal of{' '}
            <b className="mono">18.0%</b>. Atlas modeled <span className="mono">312 historical lots</span> from this Australian Hard Red wheat source —
        ...
        <article className="card diag-card action">
          <div className="diag-head">
            ...
            <div>
              <div className="card-eyebrow cyan"><span className="ce-dot info" />ATLAS · RECOMMENDED ACTION</div>
        ...
        <article className="card diag-card forecast">
          <div className="diag-head">
            ...
            <div>
              <div className="card-eyebrow green"><span className="ce-dot ok" />FORECAST · AFTER ACTION</div>
          ...
          <div className="fc-curve">
            <svg viewBox="0 0 320 110" preserveAspectRatio="none">
              <defs>
                <linearGradient id="aaiFcArea2" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="rgba(52,211,153,0.35)" />
                  <stop offset="100%" stopColor="rgba(52,211,153,0)" />
                </linearGradient>
                <linearGradient id="aaiFcAreaC" x1="0" y1="0" x2="0" y2="1">
              ...
              <path d="M 0 64 C 28 70, 56 60, 80 66 S 130 78, 160 70 L 160 110 L 0 110 Z" fill="url(#aaiFcAreaC)" />
              <path d="M 160 70 C 184 56, 208 42, 232 38 S 296 34, 320 36" fill="none" stroke="#34d399" strokeWidth="1.8" strokeDasharray="4 3" />
              <path d="M 160 70 C 184 56, 208 42, 232 38 S 296 34, 320 36 L 320 110 L 160 110 Z" fill="url(#aaiFcArea2)" />
      ...
      <div className="row row-yield-4">
        ...
        <div className="right-col">
          ...
          <div className="recs-block">
            <div className="card-eyebrow"><span className="ce-dot info" />What Atlas recommends · prioritized</div>
