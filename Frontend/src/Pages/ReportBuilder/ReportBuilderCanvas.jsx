...
export default function ReportBuilderCanvas() {
  ...
  if (loading) {
    return (
      <div className="report-builder flex flex-col h-[calc(100vh-70px)] overflow-hidden">
  ...
  /* ═══════════════════════  RENDER  ═══════════════════════════ */
  return (
    <div className="report-builder flex flex-col h-[calc(100vh-70px)] overflow-hidden bg-[var(--rb-surface)]">
      {/* ── Top Toolbar ── */}
