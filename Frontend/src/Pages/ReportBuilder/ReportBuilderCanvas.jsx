...
export default function ReportBuilderCanvas() {
  ...
  if (loading) {
    return (
      <div className="report-builder flex flex-col h-[calc(100vh-52px)] overflow-hidden">
  ...
  /* ═══════════════════════  RENDER  ═══════════════════════════ */
  return (
    <div className="report-builder flex flex-col h-[calc(100vh-52px)] overflow-hidden bg-[var(--rb-surface)]">
      {/* ── Top Toolbar ── */}
