...
import { FaKey, FaCheck, FaTimes, FaTrash, FaSync, FaCalendarPlus } from 'react-icons/fa';
            ...
            <table className="w-full text-[12px]">
              <thead>
                <tr className="border-b border-[#e3e9f0] dark:border-[#1e2d40]">
                  ...
                  <th className="text-left py-2 px-3 text-[10px] font-semibold uppercase text-[#6b7f94]">User</th>
                  ...
                  <th className="text-left py-2 px-3 text-[10px] font-semibold uppercase text-[#6b7f94]">Created</th>
              ...
              <tbody>
                {licenses.map(lic => (
                  <tr key={lic.id} className="border-b border-[#e3e9f0] dark:border-[#1e2d40] hover:bg-[#f5f8fb] dark:hover:bg-[#0d1825]">
                    <td className="py-2.5 px-3 font-mono text-[11px] text-[#2a3545] dark:text-[#e1e8f0]">
                      {lic.machine_id}
                    </td>
                    ...
                    <td className="py-2.5 px-3 text-[#8898aa]">{formatDate(lic.created_at)}</td>
