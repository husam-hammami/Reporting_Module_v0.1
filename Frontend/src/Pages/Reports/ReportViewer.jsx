...
function SingleReportView({ reportId, onBack }) {
  ...
  if (loading) return <div className="flex items-center justify-center h-[calc(100vh-70px)] text-[12px] text-[#8898aa]">Loading report...</div>;

  return (
    <div className="flex flex-col h-[calc(100vh-70px)] bg-[#f5f8fb] dark:bg-[#0b111e]">
