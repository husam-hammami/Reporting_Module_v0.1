    ...
    >
                  ...
                  >
                    {isActive && (
                      <motion.div 
                        ...
                        className="absolute left-0 top-2 bottom-2 w-[3px] rounded-r-full bg-[#22d3ee] shadow-[0_0_8px_rgba(34,211,238,0.5)]" 
                      />
                    )}
                    <item.icon
                      size={22}
      ...
      <Box sx={{ mt: 'auto', display: 'flex', flexDirection: 'column', gap: '8px', width: '100%', pb: 3, px: 0.75 }}>
        ...
        >
          ...
          {open && <span className="text-[13px] font-medium whitespace-nowrap text-[#8899ab]">Profile</span>}
        </div>
        <div
          className="w-full h-12 flex items-center text-[#556677] hover:text-[#f0f4f8] hover:bg-[#1a2233] hover:shadow-[0_0_12px_rgba(34,211,238,0.1)] rounded-lg transition-all duration-300 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-[#22d3ee]"
          style={{
        ...
        >
          ...
          {open && <span className="text-[13px] font-medium whitespace-nowrap text-[#8899ab]">Settings</span>}
        </div>
      </Box>
    </Box>
  );
